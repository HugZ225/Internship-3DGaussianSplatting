...
def create_pointcloud_for_camera(cam_id, extrinsics_dict, camera_path):
    color_path = f"/home/hmc/gaussian-splatting/GS_projects/data/JustMonkey/images/Cam{cam_id}.png"
    depth_path = f"/home/hmc/gaussian-splatting/GS_projects/data/JustMonkey/depths/Cam{cam_id}.png"
...
def main():
    images_txt = "/home/hmc/gaussian-splatting/GS_projects/data/JustMonkey/sparse/0/images.txt"
    cameras_txt = "/home/hmc/gaussian-splatting/GS_projects/data/JustMonkey/sparse/0/cameras.txt"
    ...
    R_transform = pcd_combined.get_rotation_matrix_from_xyz((
        0,  # 90° autour de X
        np.deg2rad(180),  # 90° autour de Y
        np.deg2rad(90)               # 0° autour de Z
    ))    
    pcd_combined.rotate(R_transform, center=(0, 0, 0))
